...
private struct AudienceChip: View {
    ...
    private var color: Color {
        ...
        case "admin": return DS.Colors.info
        case "marketing": return DS.Colors.warning
        default: return DS.Colors.Text.tertiary
        }
    }
