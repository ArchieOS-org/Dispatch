...
struct NativeSplitView<Sidebar: View, Content: View>: NSViewControllerRepresentable {
    ...
    func makeNSViewController(context: Context) -> DispatchSplitViewController {
    ...
    func updateNSViewController(_ nsViewController: DispatchSplitViewController, context: Context) {
...
class DispatchSplitViewController: NSSplitViewController {
