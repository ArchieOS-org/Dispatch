...
struct UserTypeTests {
    ...
    func testAllCases() {
        #expect(UserType.allCases.count == 4)
    ...
    func testCodable() throws {
        let types: [UserType] = [.realtor, .admin, .marketing, .exec]
        for type in types {
...
struct CreationSourceTests {
    ...
    func testAllCases() {
        ...
        #expect(CreationSource.allCases.contains(.import_))
    }
    ...
    func testRawValues() {
        ...
        #expect(CreationSource.import_.rawValue == "import")
    }
}
...
struct SyncStatusTests {
    ...
    @Test("SyncStatus has all expected cases")
    func testAllCases() {
        #expect(SyncStatus.allCases.count == 4)
        #expect(SyncStatus.allCases.contains(.synced))
        #expect(SyncStatus.allCases.contains(.pending))
        #expect(SyncStatus.allCases.contains(.error))
        #expect(SyncStatus.allCases.contains(.syncing))
    }
...
struct ConflictStrategyTests {
    ...
    func testAllCases() {
        ...
        #expect(ConflictStrategy.allCases.contains(.realtorPriority))
    ...
    func testRawValues() {
        ...
        #expect(ConflictStrategy.realtorPriority.rawValue == "realtor_priority")
