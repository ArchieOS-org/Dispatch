...
// MARK: - Claim Race Condition Tests
...
// MARK: - Cross-Entity Access Tests
...
final class RLSTestHelper {
    ...
    func authenticatedClient(as userId: UUID) async throws -> Any {
