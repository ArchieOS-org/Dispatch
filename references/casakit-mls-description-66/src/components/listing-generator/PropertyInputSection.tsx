...
interface PropertyInputSectionProps {
  userInput: string;
...
export const PropertyInputSection = ({
  userInput,
  setUserInput,
  propertyType,
  setPropertyType,
  ...
  return (
    <div className="flex flex-col section-spacing">
      ...
      <div className="text-center py-6 md:py-8">
        <h1 className="text-2xl md:text-4xl font-light tracking-tight text-foreground mb-3">
      ...
      <div className="subsection-spacing animate-fade-in">
